...
public class Configs implements IConfigHandler {
    ...
    public static class Generic {
        ...
        public static final ConfigBoolean           FALLING_LEAF_BIOME_TINT                 = new ConfigBoolean         ("fallingLeafBiomeTint",                true,                                               "Falling leaf particles use the foliage colormap instead\nof the colors specified in #Colors.\n§6Note: The alphas from #Colors always apply, and this\n§6setting does nothing for spruce, birch or azalea leaves!");
        ...
        public static final ConfigBooleanHotkeyed   FALLING_LEAF_PARTICLES_ENABLED          = new ConfigBooleanHotkeyed ("fallingLeafParticlesEnabled",         true, "Y,L", KeybindSettings.DEFAULT,   "Master toggle for all falling leaf particles in this mod.", "Falling Leaf Particles");
        ...
        public static final ConfigOptionList        FALLING_LEAF_MODE                       = new ConfigOptionList      ("fallingLeafMode",                     FallingLeafMode.ALL,                                            "Which leaves the falling leaf particles can generate under.");
    ...
    public static class Particles {
        ...
        public static final ConfigBoolean   PARTICLE_SNORE                  = new ConfigBoolean("particleSnore",                false, "Enables foxes, cats, bats and villagers emitting\nsnoring particles while sleeping.");
    ...
    public static class ParticleRarities {
        ...
        public static final ConfigInteger   FALLING_OAK_LEAF_PARTICLE_RARITY        = new ConfigInteger("fallingOakLeafParticleRarity",         200, 1, 512,    "The chance per gametick of an oak leaf falling from\noak leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_SPRUCE_LEAF_PARTICLE_RARITY     = new ConfigInteger("fallingSpruceLeafParticleRarity",      200, 1, 512,    "The chance per gametick of a spruce leaf falling from\nspruce leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_BIRCH_LEAF_PARTICLE_RARITY      = new ConfigInteger("fallingBirchLeafParticleRarity",       200, 1, 512,    "The chance per gametick of a birch leaf falling from\nbirch leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_JUNGLE_LEAF_PARTICLE_RARITY     = new ConfigInteger("fallingJungleLeafParticleRarity",      200, 1, 512,    "The chance per gametick of a jungle leaf falling from\njungle leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_ACACIA_LEAF_PARTICLE_RARITY     = new ConfigInteger("fallingAcaciaLeafParticleRarity",      200, 1, 512,    "The chance per gametick of an acacia leaf falling from\nacacia leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_DARK_OAK_LEAF_PARTICLE_RARITY   = new ConfigInteger("fallingDarkOakLeafParticleRarity",     200, 1, 512,    "The chance per gametick of a dark oak leaf falling from\ndark oak leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_MANGROVE_LEAF_PARTICLE_RARITY   = new ConfigInteger("fallingMangroveLeafParticleRarity",    200, 1, 512,    "The chance per gametick of a mangrove leaf falling from\nmangrove leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_AZALEA_LEAF_PARTICLE_RARITY     = new ConfigInteger("fallingAzaleaLeafParticleRarity",      200, 1, 512,    "The chance per gametick of an azalea leaf falling from\nazalea or flowering azalea leaves in 1/x.\nDefault: 200");
        public static final ConfigInteger   FALLING_AZALEA_PETAL_PARTICLE_RARITY    = new ConfigInteger("fallingAzaleaPetalParticleRarity",     300, 1, 512,    "The chance per gametick of a petal leaf falling from\nflowering azalea leaves in 1/x.\nDefault: 300");
    ...
    public static class Colors {
        ...
        public static final ConfigColorList     FALLING_OAK_LEAF_PARTICLE_COLORS        = new ConfigColorList   ("fallingOakLeafParticleColors",        ImmutableList.of(Color4f.fromColor(0xFF59AE30)),    "The list of colors from which the falling oak leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_SPRUCE_LEAF_PARTICLE_COLORS     = new ConfigColorList   ("fallingSpruceLeafParticleColors",     ImmutableList.of(Color4f.fromColor(0xFF619961)),    "The list of colors from which the falling spruce leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_BIRCH_LEAF_PARTICLE_COLORS      = new ConfigColorList   ("fallingBirchLeafParticleColors",      ImmutableList.of(Color4f.fromColor(0xFF80A755)),    "The list of colors from which the falling birch leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_JUNGLE_LEAF_PARTICLE_COLORS     = new ConfigColorList   ("fallingJungleLeafParticleColors",     ImmutableList.of(Color4f.fromColor(0xFF30BB0B)),    "The list of colors from which the falling jungle leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_ACACIA_LEAF_PARTICLE_COLORS     = new ConfigColorList   ("fallingAcaciaLeafParticleColors",     ImmutableList.of(Color4f.fromColor(0xFFAEA42A)),    "The list of colors from which the falling acacia leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_DARK_OAK_LEAF_PARTICLE_COLORS   = new ConfigColorList   ("fallingDarkOakLeafParticleColors",    ImmutableList.of(Color4f.fromColor(0xFF59AE30)),    "The list of colors from which the falling spruce leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        public static final ConfigColorList     FALLING_MANGROVE_LEAF_PARTICLE_COLORS   = new ConfigColorList   ("fallingMangroveLeafParticleColors",   ImmutableList.of(Color4f.fromColor(0xFF8DB127)),    "The list of colors from which the falling mangrove leaf\nparticles will pick randomly when created." + COLOR_OPTION_SUFFIX);
        ...
        public static final ConfigInteger       FALLING_AZALEA_LEAF_PARTICLE_ALPHA      = new ConfigInteger     ("fallingAzaleaLeafParticleAlpha",      255, 0, 255,             "The transparency of the falling azalea leaf particles.\n§6Note: This doesn't have a color option because azalea leaves\n§6don't tint!");
